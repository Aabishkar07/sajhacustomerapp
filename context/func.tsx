...
export const addCart = async (id,product_id, name, price, quantity, image_url,is_wholesale,variation) => {
  try {
    ...
    if (existingProductIndex !== -1) {
      ...
      cart.push({ id,product_id, name, price, quantity, image_url,is_wholesale,variation });
    }
